...
var ayle = document.getElementById("ayle");
var set = document.getElementById("set");

set.onmouseover = function () {
  ayle.style.opacity = 0.1;
  ayle.style.WebkitTransition = 'opacity 0.5s';
  ayle.style.MozTransition = 'opacity 0.5s';
}

set.onmouseout = function () {
  ayle.style.opacity = 1;
  ayle.style.WebkitTransition = 'opacity 0.5s';
  ayle.style.MozTransition = 'opacity 0.5s';
}